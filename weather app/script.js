...
function getWeather(){
  ...
  fetch(url)
    ...
    .then(data => {
      ...
      document.querySelector("#windSpeed").innerHTML = `<i class="fas fa-fan"></i> ${windSpeed} m/s`;
      document.querySelector("#humidity").innerHTML = `<i class="fas fa-droplet"></i> ${humidity}%`;
